    ...
    <TitleText
     ...
     />
      ...
      >
        ...
        <div className="absolute top-1/2 left-[20%] p-[6px] rounded-[24px] bg-[#9096a8] glassmorphism ">
        <img src="group-02.png" alt="people" className="w-full h-full " />
        </div>

        <div className="absolute top-10 right-20 p-[6px] rounded-[24px] glassmorphism bg-[#9096a8]  ">
